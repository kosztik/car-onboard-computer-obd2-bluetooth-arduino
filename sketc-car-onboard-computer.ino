        ...
        switch(key)
        {
          ...
          //   ˇˇˇ - you will need to change these values for your own AD keyboard
           case 0:Serial.println("sw 1");
                  ...
                  Serial.println(i2c_eeprom_read_char(0x50, 1));
                  break;
           case 20:
           case 19:Serial.println("sw 2");
                   i2c_eeprom_write_char(0x50, 1,19);
                  break;
...
uint8_t i2c_eeprom_read_char(uint8_t deviceaddress, uint8_t eeaddress) {
...
void i2c_eeprom_write_char(uint8_t deviceaddress, uint8_t eeaddress, uint8_t data) {
  byte rdata = data;
  Wire.beginTransmission(deviceaddress);
